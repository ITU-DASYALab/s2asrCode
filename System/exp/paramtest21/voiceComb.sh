...
#SBATCH -J voice-p21
#SBATCH -o ./logs/voice-p21-%A-%a-%N.out
#SBATCH -N 1
#SBATCH --array=0-19%1
#SBATCH -t 12:00:00
#SBATCH -c 48
...
input_tfrecord="FE_data/ENCombined/FE_Chars/train*.tfrecord"
input_tfrecord_eval="FE_data/ENCombined/FE_Chars/dev*.tfrecord"
dictionary="EN_chars"
model="StreamSpeechM33"
wordcollection="ENCombined_word.txt"
